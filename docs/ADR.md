...
Opcja 2:  Java + AWS + PostgreSQL (wybrana)
    ...
    • Wady:
        ◦ [-] Nie spełnia głównego celu zespołu, jakim jest rozwój kompetencji w Java.
        ◦ [-] Wymagałoby to większego nakładu pracy na wdrożenie autoryzacji i logowania niż w przypadku gotowych usług Azure.
...
Negatywne
    ...
    • [-] Potencjalnie wyższe koszty utrzymania w chmurze w porównaniu do tańszych rozwiązań hostingowych.
