...
const resources = {
  en: {
    translation: {
      ...
      sent: "Sent",
      friend: "Friend",
      recipientNotFoundEmail: "No registered email address with that name found in the database",
      ...
      confirmAddIncompatiblePlant: "Are you sure you want to add this plant despite incompatibility?",
      showOnlyCompatible: "Show only compatible fish",
      showWarnings: "Show warnings",
      fishFill: "Fill: (limit: {{limit}} fish, currently: {{current}})",
      plantFill: "Maximum {{remaining}} more (limit: {{limit}} plants, currently: {{current}})",
    foodChain: "Food Chain",
    foodChainDescription: "Aggressive fish may eat peaceful ones",
    osmoticShock: "Osmotic Shock",
    osmoticShockDescription: "Fish with incompatible water type will die",
      ...
      fishWarnings: "Warnings (fish)",
      plantWarnings: "Warnings (plants)",
      moreIssues: "more",
      ...
      fishMayNotSurvive: "Fish may not survive in such conditions",
      plantMayNotSurvive: "Plant may not survive in such conditions",
      osmoticShockMismatch: "Osmotic shock: {{fishName}} – mismatched: {{reasons}}.",
      plasmolysisMismatch: "Plasmolysis: {{plantName}} – mismatched: {{reasons}}.",
      osmoticShockWarning: "⚠️ {{fishName}} cannot survive in this environment (mismatched: {{reasons}}). Osmotic shock will occur...",
      osmoticShockDeath: "💀 {{fishName}} did not survive in this environment (Osmotic shock)!",
      osmoticShockPlantWarning: "⚠️ {{plantName}} cannot survive in this environment (mismatched: {{reasons}}). Osmotic shock will occur...",
      osmoticShockPlantDeath: "💀 {{plantName}} did not survive in this environment (Osmotic shock)!",
      plasmolysisWarning: "⚠️ {{plantName}} cannot survive in this environment (mismatched: {{reasons}}). Plasmolysis will occur...",
      plasmolysisDeath: "💀 {{plantName}} did not survive in this environment (Plasmolysis)!",
      plasmolysis: "Plasmolysis",
      plasmolysisDescription: "Plants with mismatched parameters will die",
      selectedFishParameters: "Selected fish parameters",
      selectedPlantParameters: "Selected plant parameters",
      years: "years",
      ...
      fish: {
        ...
        temperament: {
          ...
          pol_agresywne: "semi-aggressive"
        },
        biotopes: {
          azja: "Asia",
          ameryka_poludniowa: "South America",
          ameryka_polnocna: "North America",
          afryka: "Africa",
      ...
      adminNoAccess: "You don't have administrator privileges. Access to the admin panel is restricted.",
      adminAccessCheckError: "Error while checking administrator privileges",
      adminDataLoadError: "Error loading data",
      adminToggleRightsError: "Error while changing administrator privileges",
      adminDeleteUserError: "Error while deleting user",
      adminDeleteAquariumError: "Error while deleting aquarium",
      adminDeleteFishError: "Error while deleting fish",
      adminDeletePlantError: "Error while deleting plants",
      adminPanel: "Admin Panel",
      adminPanelDescription: "Manage users, logs and system data",
      adminLogs: "Logs",
      adminUsers: "Users",
      adminSystemData: "System Data",
      adminLogsTitle: "Application Logs",
      adminLogDate: "Date",
      adminLogUser: "User",
      adminLogAction: "Action",
      adminLogDetails: "Details",
      adminUsersTitle: "User Management",
      adminUsersComingSoon: "User management functionality will be available soon. Requires AWS Cognito integration.",
      adminSystemDataTitle: "System Data",
      adminSystemDataComingSoon: "System data management functionality will be available soon.",
      noLogs: "No logs to display",
      adminFilters: "Filters",
      adminLogsCount: "found",
      adminLogUserPlaceholder: "Search by ID...",
      adminLogDateFrom: "From",
      adminLogDateTo: "To",
      adminSortBy: "Sort by",
      adminSortOrder: "Order",
      adminClearFilters: "Clear filters",
      adminLogAquarium: "Aquarium",
      adminLogsShowing: "Showing {{from}}-{{to}} of {{total}}",
      adminUsersCount: "found",
      adminUserSearch: "Search user",
      adminUserSearchPlaceholder: "Email, username, ID...",
      adminUserRole: "Role",
      adminUserRoleFilterTooltip: "Filter users by role: Administrators - can access admin panel, Regular - standard users",
      adminUserAll: "All users",
      adminUserAdmins: "Administrators",
      adminUserRegular: "Regular users",
      adminUserEmail: "Email",
      adminUserUsername: "Username",
      adminUserCreated: "Registration date",
      adminUserActions: "Management",
      adminUserToggleStatus: "Toggle status",
      adminUserToggleStatusTooltip: "Activate/Deactivate user - deactivation blocks access to the application",
      adminUserStatusActiveDesc: "User can log in and use the application",
      adminUserStatusInactiveDesc: "User is blocked and cannot log in",
      adminUserDetails: "Details",
      adminUserViewDetails: "View details and manage user",
      adminUserEdit: "Edit",
      adminUserEditComingSoon: "User editing feature will be available soon",
      adminUserDelete: "Delete",
      adminUserDeleteConfirmTitle: "Confirm user deletion",
      adminUserDeleteConfirmMessage: "Are you sure you want to delete user {{email}}? This operation is irreversible.",
      adminUserDeleteConfirm: "Delete",
      adminUserAdminRights: "Administrator privileges",
      adminUserIsAdminYes: "Yes",
      adminUserIsAdminNo: "No",
      adminUserGrantAdminRights: "Grant administrator privileges",
      adminUserRemoveAdminRights: "Remove administrator privileges",
      adminUsersShowing: "Showing {{from}}-{{to}} of {{total}}",
      adminUserDetailsTitle: "User Details",
      adminUserID: "User ID",
      adminUserCognitoSub: "Cognito Sub",
      adminUserIsAdmin: "This user has administrator privileges",
      adminNoUsers: "No users to display",
      cancel: "Cancel",
      adminSystemUsers: "Users",
      adminSystemTotalUsers: "Total users",
      adminSystemActiveUsers: "Active users",
      adminSystemInactiveUsers: "Inactive users",
      adminSystemAquariums: "Aquariums",
      adminSystemTotalAquariums: "Total aquariums",
      adminSystemFish: "Fish",
      adminSystemTotalFish: "Total fish",
      adminSystemPlants: "Plants",
      adminSystemTotalPlants: "Total plants",
      adminSystemLogs: "Logs",
      adminSystemTotalLogs: "Total logs",
      adminSystemDatabase: "Database",
      adminSystemDatabaseSize: "Database size",
      adminSystemLastBackup: "Last backup",
      adminSystemInfo: "System Information",
      adminSystemVersion: "System version",
      adminSystemEnvironment: "Environment",
      adminSystemStatus: "System status",
      adminSystemDataLoading: "Loading system data...",
      adminSystemClickToManage: "Click to manage",
      adminManageAquariums: "Manage Aquariums",
      adminManageFish: "Manage Fish",
      adminManagePlants: "Manage Plants",
      adminNoAquariums: "No aquariums to display",
      adminNoFish: "No fish to display",
      adminNoPlants: "No plants to display",
      adminAquariumName: "Name",
      adminAquariumOwner: "Owner",
      adminAquariumWaterType: "Water Type",
      adminAquariumVolume: "Volume (L)",
      adminAquariumCreated: "Created",
      adminFishSpecies: "Species",
      adminFishAquarium: "Aquarium",
      adminFishOwner: "Owner",
      adminFishCount: "Count",
      adminPlantName: "Plant Name",
      adminDeleteFish: "Remove fish from aquarium",
      adminDeletePlant: "Remove plants from aquarium",
      adminDeleteAquariumConfirmTitle: "Confirm aquarium deletion",
      adminDeleteAquariumConfirmMessage: "Are you sure you want to delete aquarium \"{{name}}\"? This operation is irreversible and will delete all associated fish and plants.",
      adminDeleteFishConfirmTitle: "Confirm fish removal",
      adminDeleteFishConfirmMessage: "Are you sure you want to remove {{count}} {{species}} from aquarium \"{{aquarium}}\"?",
      adminDeletePlantConfirmTitle: "Confirm plant removal",
      adminDeletePlantConfirmMessage: "Are you sure you want to remove {{count}} {{plant}} from aquarium \"{{aquarium}}\"?"
    }
  }
},
  pl: {
    translation: {
      ...
      sent: "Wysłane",
      friend: "Znajomy",
      recipientNotFoundEmail: "Nie znaleziono zarejestrowanego adresu email o takiej nazwie w bazie danych",
      acceptError: "Nie udało się zaakceptować zaproszenia",
      ...
      confirmAddIncompatiblePlant: "Czy na pewno chcesz dodać tę roślinę mimo niekompatybilności?",
      showOnlyCompatible: "Pokaż tylko kompatybilne ryby",
      showWarnings: "Pokaż ostrzeżenia",
      fishFill: "Zapełnienie: (limit: {{limit}} ryb, aktualnie: {{current}})",
      plantFill: "Maksymalnie {{remaining}} więcej (limit: {{limit}} roślin, aktualnie: {{current}})",
    foodChain: "Łańcuch pokarmowy",
    foodChainDescription: "Agresywne ryby mogą zjeść spokojne",
    osmoticShock: "Szok osmotyczny",
    osmoticShockDescription: "Ryby z niezgodnym typem wody zdychają",
      ...
      fishWarnings: "Ostrzeżenia (ryby)",
      plantWarnings: "Ostrzeżenia (rośliny)",
      moreIssues: "więcej",
      ...
      fishMayNotSurvive: "Ryba może nie przeżyć w takich warunkach",
      plantMayNotSurvive: "Roślina może nie przeżyć w takich warunkach",
      osmoticShockMismatch: "Szok osmotyczny: {{fishName}} – niezgodne: {{reasons}}.",
      plasmolysisMismatch: "Plazmoliza: {{plantName}} – niezgodne: {{reasons}}.",
      osmoticShockWarning: "⚠️ {{fishName}} nie jest w stanie przeżyć w tym środowisku (niezgodne: {{reasons}}). Nastąpi szok osmotyczny...",
      osmoticShockDeath: "💀 {{fishName}} nie przeżyła w tym środowisku (Szok osmotyczny)!",
      osmoticShockPlantWarning: "⚠️ {{plantName}} nie jest w stanie przeżyć w tym środowisku (niezgodne: {{reasons}}). Nastąpi szok osmotyczny...",
      osmoticShockPlantDeath: "💀 {{plantName}} nie przeżyła w tym środowisku (Szok osmotyczny)!",
      plasmolysisWarning: "⚠️ {{plantName}} nie jest w stanie przeżyć w tym środowisku (niezgodne: {{reasons}}). Nastąpi plazmoliza...",
      plasmolysisDeath: "💀 {{plantName}} nie przeżyła w tym środowisku (Plazmoliza)!",
      plasmolysis: "Plazmoliza (Plasmolysis)",
      plasmolysisDescription: "Rośliny z niezgodnymi parametrami obumierają",
      selectedFishParameters: "Parametry wybranej ryby",
      selectedPlantParameters: "Parametry wybranej rośliny",
      years: "lat",
      aggressiveness: "Agresywność",
      noSort: "Bez sortowania",
      leastAggressive: "Spokojne",
      mostAggressive: "Agresywne",
      ...
      fish: {
        ...
        values: {
          ...
          saltwater: "Słona",
          brackish: "Słonawa",
          slodkowodna: "Słodkowodna",
          slonowodna: "Słonowodna",
          slonawowodna: "Słonawowodna",
          calm: "Spokojne",
      ...
      auth: {
        ...
        logIn: "Zaloguj się",
        adminLoginRequired: "Musisz być zalogowany, aby uzyskać dostęp do panelu administratora",
        adminNoAccess: "Brak uprawnień administratora. Dostęp do panelu administratora jest ograniczony.",
        adminAccessCheckError: "Błąd podczas sprawdzania uprawnień administratora",
        adminDataLoadError: "Błąd ładowania danych",
        adminToggleRightsError: "Błąd podczas zmiany uprawnień administratora",
        adminDeleteUserError: "Błąd podczas usuwania użytkownika",
        adminDeleteAquariumError: "Błąd podczas usuwania akwarium",
        adminDeleteFishError: "Błąd podczas usuwania ryb",
        adminDeletePlantError: "Błąd podczas usuwania roślin",
        adminPanel: "Panel Admina",
        adminPanelDescription: "Zarządzanie użytkownikami, logami i danymi systemowymi",
        adminLogs: "Logi",
        adminUsers: "Użytkownicy",
        adminSystemData: "Dane Systemowe",
        adminLogsTitle: "Logi aplikacji",
        adminLogDate: "Data",
        adminLogUser: "Użytkownik",
        adminLogAction: "Akcja",
        adminLogDetails: "Szczegóły",
        adminUsersTitle: "Zarządzanie użytkownikami",
        adminUsersComingSoon: "Funkcjonalność zarządzania użytkownikami będzie dostępna wkrótce. Wymaga integracji z AWS Cognito.",
      adminSystemDataTitle: "Dane systemowe",
      adminSystemDataComingSoon: "Funkcjonalność zarządzania danymi systemowymi będzie dostępna wkrótce.",
      noLogs: "Brak logów do wyświetlenia",
      adminFilters: "Filtry",
      adminLogsCount: "znalezionych",
      adminLogUserPlaceholder: "Szukaj po ID...",
      adminLogDateFrom: "Od",
      adminLogDateTo: "Do",
      adminSortBy: "Sortuj po",
      adminSortOrder: "Kolejność",
      adminClearFilters: "Wyczyść filtry",
      adminLogAquarium: "Akwarium",
      adminLogsShowing: "Wyświetlanie {{from}}-{{to}} z {{total}}",
      adminUsersCount: "znalezionych",
      adminUserSearch: "Szukaj użytkownika",
      adminUserSearchPlaceholder: "Email, nazwa użytkownika, ID...",
      adminUserRole: "Rola",
      adminUserRoleFilterTooltip: "Filtruj użytkowników według roli: Administratorzy - mają dostęp do panelu admina, Zwykli - standardowi użytkownicy",
      adminUserAll: "Wszyscy",
      adminUserAdmins: "Administratorzy",
      adminUserRegular: "Zwykli użytkownicy",
      adminUserEmail: "Email",
      adminUserUsername: "Nazwa użytkownika",
      adminUserCreated: "Data rejestracji",
      adminUserActions: "Zarządzanie",
      adminUserToggleStatus: "Zmień status",
      adminUserToggleStatusTooltip: "Aktywuj/Deaktywuj użytkownika - deaktywacja blokuje dostęp do aplikacji",
      adminUserStatusActiveDesc: "Użytkownik może logować się i korzystać z aplikacji",
      adminUserStatusInactiveDesc: "Użytkownik jest zablokowany i nie może się logować",
      adminUserDetails: "Szczegóły",
      adminUserViewDetails: "Wyświetl szczegóły i zarządzaj użytkownikiem",
      adminUserEdit: "Edytuj",
      adminUserEditComingSoon: "Funkcja edycji użytkownika będzie dostępna wkrótce",
      adminUserDelete: "Usuń",
      adminUserDeleteConfirmTitle: "Potwierdź usunięcie użytkownika",
      adminUserDeleteConfirmMessage: "Czy na pewno chcesz usunąć użytkownika {{email}}? Ta operacja jest nieodwracalna.",
      adminUserDeleteConfirm: "Usuń",
      adminUserAdminRights: "Uprawnienia administratora",
      adminUserIsAdminYes: "Tak",
      adminUserIsAdminNo: "Nie",
      adminUserGrantAdminRights: "Nadaj uprawnienia administratora",
      adminUserRemoveAdminRights: "Odbierz uprawnienia administratora",
      adminUsersShowing: "Wyświetlanie {{from}}-{{to}} z {{total}}",
      adminUserDetailsTitle: "Szczegóły użytkownika",
      adminUserID: "ID użytkownika",
      adminUserCognitoSub: "Cognito Sub",
      adminUserIsAdmin: "Ten użytkownik ma uprawnienia administratora",
      adminNoUsers: "Brak użytkowników do wyświetlenia",
      cancel: "Anuluj",
      adminSystemUsers: "Użytkownicy",
      adminSystemTotalUsers: "Wszystkich użytkowników",
      adminSystemActiveUsers: "Aktywnych użytkowników",
      adminSystemInactiveUsers: "Nieaktywnych użytkowników",
      adminSystemAquariums: "Akwaria",
      adminSystemTotalAquariums: "Wszystkich akwariów",
      adminSystemFish: "Ryby",
      adminSystemTotalFish: "Wszystkich ryb",
      adminSystemPlants: "Rośliny",
      adminSystemTotalPlants: "Wszystkich roślin",
      adminSystemLogs: "Logi",
      adminSystemTotalLogs: "Wszystkich logów",
      adminSystemDatabase: "Baza danych",
      adminSystemDatabaseSize: "Rozmiar bazy danych",
      adminSystemLastBackup: "Ostatnia kopia zapasowa",
      adminSystemInfo: "Informacje o systemie",
      adminSystemVersion: "Wersja systemu",
      adminSystemEnvironment: "Środowisko",
      adminSystemStatus: "Status systemu",
      adminSystemDataLoading: "Ładowanie danych systemowych...",
      adminSystemClickToManage: "Kliknij, aby zarządzać",
      adminManageAquariums: "Zarządzanie akwariami",
      adminManageFish: "Zarządzanie rybami",
      adminManagePlants: "Zarządzanie roślinami",
      adminNoAquariums: "Brak akwariów do wyświetlenia",
      adminNoFish: "Brak ryb do wyświetlenia",
      adminNoPlants: "Brak roślin do wyświetlenia",
      adminAquariumName: "Nazwa",
      adminAquariumOwner: "Właściciel",
      adminAquariumWaterType: "Typ wody",
      adminAquariumVolume: "Objętość (L)",
      adminAquariumCreated: "Data utworzenia",
      adminFishSpecies: "Gatunek",
      adminFishAquarium: "Akwarium",
      adminFishOwner: "Właściciel",
      adminFishCount: "Liczba",
      adminPlantName: "Nazwa rośliny",
      adminDeleteFish: "Usuń ryby z akwarium",
      adminDeletePlant: "Usuń rośliny z akwarium",
      adminDeleteAquariumConfirmTitle: "Potwierdź usunięcie akwarium",
      adminDeleteAquariumConfirmMessage: "Czy na pewno chcesz usunąć akwarium \"{{name}}\"? Ta operacja jest nieodwracalna i usunie wszystkie powiązane ryby i rośliny.",
      adminDeleteFishConfirmTitle: "Potwierdź usunięcie ryb",
      adminDeleteFishConfirmMessage: "Czy na pewno chcesz usunąć {{count}} {{species}} z akwarium \"{{aquarium}}\"?",
      adminDeletePlantConfirmTitle: "Potwierdź usunięcie roślin",
      adminDeletePlantConfirmMessage: "Czy na pewno chcesz usunąć {{count}} {{plant}} z akwarium \"{{aquarium}}\"?"
      }
    }
  }
};
