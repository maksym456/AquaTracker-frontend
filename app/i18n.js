...
const resources = {
  en: {
    ...
    osmoticShockDescription: "Fish with incompatible water type will die",
      ...
      adminUserStatusFilterTooltip: "Filter users by status: Active - can log in to the application, Inactive - blocked",
  ...
  pl: {
    ...
    osmoticShockDescription: "Ryby z niezgodnym typem wody zdychają",
      ...
      adminUserStatus: "Status",
      adminUserStatusFilterTooltip: "Filtruj użytkowników według statusu: Aktywni - mogą logować się do aplikacji, Nieaktywni - zablokowani",
      adminUserActive: "Aktywny",
      adminUserInactive: "Nieaktywny",
      adminUserEmail: "Email",
